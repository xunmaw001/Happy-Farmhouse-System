...
public class YouwanxiangmuLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public YouwanxiangmuLiuyanEntity() {

	}

	public YouwanxiangmuLiuyanEntity(T t) {
		try {
     ...
     * 留言内容
     */
    @TableField(value = "youwanxiangmu_liuyan_content")
    ...
    public String toString() {
        return "YouwanxiangmuLiuyan{" +
            "id=" + id +
            ", youwanxiangmuId=" + youwanxiangmuId +
            ", yonghuId=" + yonghuId +
            ", youwanxiangmuLiuyanContent=" + youwanxiangmuLiuyanContent +
