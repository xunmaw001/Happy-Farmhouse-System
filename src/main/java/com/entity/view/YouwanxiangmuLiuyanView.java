 ...
 * @date 2021-04-10
 */
@TableName("youwanxiangmu_liuyan")
public class YouwanxiangmuLiuyanView extends YouwanxiangmuLiuyanEntity implements Serializable {
	...
	public YouwanxiangmuLiuyanView() {

	}

	public YouwanxiangmuLiuyanView(YouwanxiangmuLiuyanEntity youwanxiangmuLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, youwanxiangmuLiuyanEntity);
