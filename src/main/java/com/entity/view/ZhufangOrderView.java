...
public class ZhufangOrderView extends ZhufangOrderEntity implements Serializable {
	...
	public ZhufangOrderView() {

	}

	public ZhufangOrderView(ZhufangOrderEntity zhufangOrderEntity) {
		try {
			BeanUtils.copyProperties(this, zhufangOrderEntity);
