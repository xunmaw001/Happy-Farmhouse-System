...
var centerMenu = [
    ...
    ,{
        name: '游玩项目预约',
        url: '../youwanxiangmuOrder/list.jsp'
    }
    ,{
        name: '住房预约',
        url: '../zhufangOrder/list.jsp'
    }
...
var indexNav = [
    {
        name: '农庄',
        url: './pages/nongzhuang/list.jsp'
    },
    {
        name: '特色菜',
        url: './pages/tesecai/list.jsp'
    },
    {
        name: '游玩项目',
        url: './pages/youwanxiangmu/list.jsp'
    },
    {
        name: '住房',
        url: './pages/zhufang/list.jsp'
    },
    {
        name: '公告',
...
var adminurl =  "http://localhost:8080/kaixinnongjiale/index.jsp";
