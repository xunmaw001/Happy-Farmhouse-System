                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="youwanxiangmuName" id="youwanxiangmuName" placeholder="项目名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../youwanxiangmu/detail.jsp?id='+item.id)">
                                    <a href="#" class="ng-prsliik">
                                        <span class="ng-prsliik-ki ng-prsliik-ki_1">
                                            <img class="swiper-item" :src="item.youwanxiangmuPhoto?item.youwanxiangmuPhoto.split(',')[0]:''" />
                                        </span>
                                ...
                                <div class="ng-prslist-tit" @click="jump('../youwanxiangmu/detail.jsp?id='+item.id)"><span>{{item.youwanxiangmuName}}</span></div>
                                <div class="ng-prslist-tit" v-if="item.youwanxiangmuNewMoney"><span style="color: red;">{{item.youwanxiangmuNewMoney}} RMB</span></div>
                            </div>
                        </li>
                    </ul>
                </div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 youwanxiangmuContent 字段去除无用字符 如果字段长度大于60  就截取到60
            youwanxiangmuContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#youwanxiangmuName').val() != null && jquery('#youwanxiangmuName').val() != "" && jquery('#youwanxiangmuName').val() != "null" ) {
                param['youwanxiangmuName'] = jquery('#youwanxiangmuName').val();
            }
            ...
            if (leixingTypes != null && leixingTypes != "" && leixingTypes != "null") {
                param['leixingTypes'] = leixingTypes;
                        ...
                        // 获取列表数据
            http.request('youwanxiangmu/list', 'get', param, function(res) {
