                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="nongzhuangName" id="nongzhuangName" placeholder="农庄名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../nongzhuang/detail.jsp?id='+item.id)">
                                    <a href="#" class="ng-prsliik">
                                        <span class="ng-prsliik-ki ng-prsliik-ki_1">
                                            <img class="swiper-item" :src="item.nongzhuangPhoto?item.nongzhuangPhoto.split(',')[0]:''" />
                                        </span>
                                ...
                                <div class="ng-prslist-tit" @click="jump('../nongzhuang/detail.jsp?id='+item.id)"><span>{{item.nongzhuangName}}</span></div>
                                <div class="ng-prslist-tit" v-if="item.nongzhuangNewMoney"><span style="color: red;">{{item.nongzhuangNewMoney}} RMB</span></div>
                            </div>
                        </li>
                    </ul>
                </div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 nongzhuangContent 字段去除无用字符 如果字段长度大于60  就截取到60
            nongzhuangContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#nongzhuangName').val() != null && jquery('#nongzhuangName').val() != "" && jquery('#nongzhuangName').val() != "null" ) {
                param['nongzhuangName'] = jquery('#nongzhuangName').val();
            }
                                            // 获取列表数据
            http.request('nongzhuang/list', 'get', param, function(res) {
