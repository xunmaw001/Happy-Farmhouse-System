                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="tesecaiName" id="tesecaiName" placeholder="菜品名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
         
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <label class="layui-form-label">菜品口味</label>
                          <div class="layui-input-inline">
                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../tesecai/detail.jsp?id='+item.id)">
                                    <a href="#" class="ng-prsliik">
                                        <span class="ng-prsliik-ki ng-prsliik-ki_1">
                                            <img class="swiper-item" :src="item.tesecaiPhoto?item.tesecaiPhoto.split(',')[0]:''" />
                                        </span>
                                ...
                                <div class="ng-prslist-tit" @click="jump('../tesecai/detail.jsp?id='+item.id)"><span>{{item.tesecaiName}}</span></div>
                                <div class="ng-prslist-tit" v-if="item.tesecaiNewMoney"><span style="color: red;">{{item.tesecaiNewMoney}} RMB</span></div>
                            </div>
                        </li>
                    </ul>
                </div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 tesecaiContent 字段去除无用字符 如果字段长度大于60  就截取到60
            tesecaiContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#tesecaiName').val() != null && jquery('#tesecaiName').val() != "" && jquery('#tesecaiName').val() != "null" ) {
                param['tesecaiName'] = jquery('#tesecaiName').val();
            }
            ...
            if (leixingTypes != null && leixingTypes != "" && leixingTypes != "null") {
                param['leixingTypes'] = leixingTypes;
                        ...
                        // 获取列表数据
            http.request('tesecai/list', 'get', param, function(res) {
