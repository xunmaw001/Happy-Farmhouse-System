    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">游玩项目留言管理</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">游玩项目留言列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">游玩项目留言列表</h3>
...
<script>
    ...
    function getDataList() {
        http("youwanxiangmuLiuyan/page", "GET", {
            page: pageIndex,
            limit: pageSize,
            sort: sortColumn,
            order: sortOrder,
    ...
    function setDataRow(item, number) {
        ...
        row.appendChild(youwanxiangmuNameCell);
            ...
            //留言内容
        var youwanxiangmuLiuyanContentCell = document.createElement('td');
        //如果图文详情包含图片
        if (item.youwanxiangmuLiuyanContent && item.youwanxiangmuLiuyanContent.indexOf('img') != -1) {
            //暂时只考虑图片+文字 和 文字+图片的情况
            var beginIndex = item.youwanxiangmuLiuyanContent.indexOf('<img');
            var endIndex = item.youwanxiangmuLiuyanContent.indexOf('>');
                youwanxiangmuLiuyanContentCell.innerHTML = item.youwanxiangmuLiuyanContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
        } else {
            if (item.youwanxiangmuLiuyanContent != null && item.youwanxiangmuLiuyanContent != "" && item.youwanxiangmuLiuyanContent.length >= 11) {
                    youwanxiangmuLiuyanContentCell.innerHTML = item.youwanxiangmuLiuyanContent.substring(0, 10) + "...";
            } else {
                    youwanxiangmuLiuyanContentCell.innerHTML = item.youwanxiangmuLiuyanContent;
            }
        }
        row.appendChild(youwanxiangmuLiuyanContentCell);
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("youwanxiangmuLiuyan/delete", "POST", paramArray, (res) => {
                if(res.code == 0){
                    getDataList();
                    alert('删除成功');
                }
    ...
    //添加
    function add() {
        window.sessionStorage.setItem("addyouwanxiangmuLiuyan", "addyouwanxiangmuLiuyan");
        window.location.href = "add-or-update.jsp"
    }
